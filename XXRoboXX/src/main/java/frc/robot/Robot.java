...
public class Robot extends HuskyRobot {
  ...
  private XXRoboXXTeleopDecisionMaker m_TeleopDecider = new XXRoboXXTeleopDecisionMaker();
  private XXRoboXXAutonomousDecisionMaker m_AutoDecider = new XXRoboXXAutonomousDecisionMaker();

XXRoboSubsystemDeclarationsXX
