...
public class XXRoboXXJoystick extends HuskyJoystick{
  private static final int XXRoboXX_JOYSTICK_PORT = 0;
  ...
  public XXRoboXXJoystick(){
      super(XXRoboXX_JOYSTICK_PORT);
  }
